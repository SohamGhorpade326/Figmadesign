...
const Services2: React.FC = () => {
    return (
        // KEY CHANGE: Removed bg-color, increased bottom padding for space.
        <section id="services" className="pt-24 md:pt-32 pb-48 relative">
            ...
            {/* --- THIS GRADIENT SITS BEHIND THE CONTENT --- */}
            <div
              aria-hidden="true"
              className="absolute bottom-0 left-0 w-full h-[70vh] bg-gradient-to-t from-[#111111] via-pink-500/20 to-transparent z-0"
            ></div>
        </section>
    );
};
